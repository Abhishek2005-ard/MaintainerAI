    ...
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-margin-desktop hero-radial-glow pt-24">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto my-auto py-12 animate-fade-in-up">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
          <button className="w-full sm:w-auto bg-white text-black font-label-md text-body-md px-8 py-3.5 rounded-xl hover:bg-neutral-200 hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-white/10 flex items-center justify-center gap-2 font-semibold">
            <span className="material-symbols-outlined text-xl">download</span>
            Install on GitHub
          </button>
          <a
            href="#dashboard"
            className="w-full sm:w-auto border border-outline/50 text-on-surface font-label-md text-body-md px-8 py-3.5 rounded-xl hover:bg-surface-variant hover:border-white/40 transition-all flex items-center justify-center gap-2"
          >
            <span className="material-symbols-outlined text-xl text-white animate-pulse">play_circle</span>
            See how it works
          </a>
        </div>
