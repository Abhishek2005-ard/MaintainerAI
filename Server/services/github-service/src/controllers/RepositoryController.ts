...
export const getRepositories = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const syncRepositories = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const toggleTriageRules = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
