...
export const handleCallback = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const getInstallUrl = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const handleInstallationCallback = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
