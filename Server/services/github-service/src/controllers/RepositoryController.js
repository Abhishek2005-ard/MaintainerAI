...
export const getRepositories = catchAsync(async (req, res) => {
...
export const syncRepositories = catchAsync(async (req, res) => {
...
export const toggleTriageRules = catchAsync(async (req, res) => {
