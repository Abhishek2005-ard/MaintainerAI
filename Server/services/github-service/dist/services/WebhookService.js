...
export const handleInstallationEvent = async (payload) => {
    ...
    if (action === 'created' || action === 'new_permissions_accepted') {
        ...
        await InstallationModel.findOneAndUpdate({ installationId }, {
        ...
        await InstallationModel.findOneAndUpdate({ installationId }, { status: 'suspended' });
        logger.info(`Suspended installation id ${installationId}.`);
    }
    else if (action === 'unsuspend') {
        await InstallationModel.findOneAndUpdate({ installationId }, { status: 'active' });
